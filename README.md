...
>
> **兑换方式：** 将内容链接、平台登录截图（证明账号所有权）邮件到 Cp0204#qq.com (#替换@），这则公告还挂着就长期有效。参加并兑换成功默认视为授权 SmartStrm 对内容公开引用、保留原作者信息前提下的[整理和转载](#第三方教程)。
>
...
#### Q: 如何订阅和激活 Pro？
> A: [订阅入口](https://afdian.com/item/cd39184033a811f0b60b52540025c377)；另外，在 SmartStrm 后台的左下角，点 “免费版” 可以跳转，已经是 Pro 的，点击时间可以跳转到续订。
>
